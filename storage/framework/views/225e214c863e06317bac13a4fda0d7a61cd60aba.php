  ...
  <div class="card p-4 shadow" style="width: 100%; max-width: 400px;">
    ...
    <form method="POST" action="<?php echo e(route('register.store')); ?>">
      ...
      <div class="d-flex justify-content-center align-items-center mt-3 gap-2">
        ...
        <a href="<?php echo e(route('login')); ?>" class="text-decoration-none">Log in</a>
      </div>
    </form>
  </div>
</div>
...
</html><?php /**PATH C:\Users\USER\Documents\Kelas 11\Website Data\app\crud\resources\views/register.blade.php ENDPATH**/ ?>