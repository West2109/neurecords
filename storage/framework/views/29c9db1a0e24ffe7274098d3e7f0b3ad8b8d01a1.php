  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <?php if(auth()->guard()->check()): ?>
        <form method="GET" action="<?php echo e(route('create')); ?>">
          <?php echo csrf_field(); ?>
...
<div id="home" style="
  background-image: url('<?php echo e(asset('images/homeBackground.jpg')); ?>');
  width: 100vw;
  min-height: 100vh;
...
">
  <div class="container text-white">
    <h1>Welcome to Neu Timer</h1>
    <p>Your utmost solution for time management.</p>
    ...
    <div class="col-12 col-md-6 col-lg-4 mb-4">
      <div class="card h-100">
        <div class="ratio ratio-1x1">
          ...
          <div class="card-body">
          <h5 class="card-title">Cooking Timer</h5>
          <p class="card-text">Help you cook your foods to your desired degree.</p>
        </div>
        <div class="card-body d-flex justify-content-between">
          <a href="<?php echo e(url('cooking')); ?>" class="btn btn-outline-dark">Try</a>
    ...
    <div class="col-12 col-md-6 col-lg-4 mb-4">
      <div class="card h-100">
        <div class="ratio ratio-1x1">
          ...
          <div class="card-body">
          <h5 class="card-title">Studying Timer</h5>
...
<div id="about" class="container mt-5">
  <h2>About Us</h2>
  <p>Neu Timer is a web application designed to help you manage your time effectively. 
  With our intuitive interface and powerful features, you can track your tasks, set reminders, and stay organized.</p>
  <p>Time management is of great importance, that's why our clients have been using Neu Timer for their best choice.</p> 
  ...
  <div class="row mt-4 gap-5">
    ...
    <div class="col-md-3 text-center p-4 mb-4" style="border: 2px solidrgb(0, 0, 0); border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      ...
      <p>"Neu Timer has completely transformed the way I manage my tasks. Looking forward to the methamphetamine cooking feature!"</p>
    </div>
    <!-- Client 2 -->
    <div class="col-md-3 text-center p-4 mb-4" style="border: 2px solidrgb(0, 0, 0); border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      ...
      <p>"The best timer tool I've ever used. Cooking was the only thing I had difficulty in. It's simple and effective!"</p>
    </div>
    <!-- Client 3 -->
    <div class="col-md-3 text-center p-4 mb-4" style="border: 2px solidrgb(0, 0, 0); border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      <img src="<?php echo e(asset('images/chineseClient.jpg')); ?>" alt="Client 3" class="rounded-circle" style="width: 100px; height: 100px;">
      <h5 class="mt-3">Leonardo Johnson</h5>
      <p class="text-muted">China</p>
      <p>"Neu Timer helps me stay productive every day. I would never eat an overcooked egg again. I love it!"</p>
    </div>
  </div>
</div>
</div>
...
</html><?php /**PATH C:\Users\USER\Documents\Kelas 11\Website Data\app\crud\resources\views/welcome.blade.php ENDPATH**/ ?>