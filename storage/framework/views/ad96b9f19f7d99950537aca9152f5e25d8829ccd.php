  ...
  <div class="card p-4 shadow" style="width: 100%; max-width: 400px;">
    ...
    <form method="POST" action="<?php echo e(route('login.attempt')); ?>">
      ...
      <div class="d-flex justify-content-center align-items-center mt-3 gap-2">
        ...
        <a href="<?php echo e(url('register')); ?>" class="text-decoration-none">Register</a>
      </div>
    </form>
  </div>
</div>
...
</html><?php /**PATH C:\Users\USER\Documents\Kelas 11\Website Data\app\crud\resources\views/login.blade.php ENDPATH**/ ?>