...
<div id="features" class="container px-3">
  ...
  <div class="row">
    <div class="col-12 col-md-6 col-lg-4 mb-4">
      <div class="card h-100">
        <div class="ratio ratio-1x1">
          <img src="{{ asset('images/cookingThumbnail.avif') }}" class="card-img-top object-fit-cover" alt="...">
        </div>
          <div class="card-body">
        ...
        <div class="card-body d-flex justify-content-between">
          ...
          @else
          <a href="{{ route('login') }}" class="btn btn-outline-dark">Try</a>
          @endauth
    ...
    <div class="col-12 col-md-6 col-lg-4 mb-4">
      <div class="card h-100">
        <div class="ratio ratio-1x1">
          <img src="{{ asset('images/studyingThumbnail.jpg') }}" class="card-img-top object-fit-cover" alt="...">
        </div>
          <div class="card-body">
    ...
    <div class="col-12 col-md-6 col-lg-4 mb-4">
      <div class="card h-100">
        <div class="ratio ratio-1x1">
          <img src="{{ asset('images/productivityThumbnail.jpeg') }}" class="card-img-top object-fit-cover" alt="...">
        </div>
          <div class="card-body">
...
<div id="about" class="container mt-5">
  ...
  <div class="row mt-4 gap-5">
    ...
    <div class="col-md-3 text-center p-4 mb-4" style="border: 2px solidrgb(0, 0, 0); border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      <img src="{{ asset('images/americanClient.webp') }}" alt="Client 1" class="rounded-circle" style="width: 100px; height: 100px;">
    ...
    <!-- Client 2 -->
    <div class="col-md-3 text-center p-4 mb-4" style="border: 2px solidrgb(0, 0, 0); border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      <img src="{{ asset('images/belgiumClient.jpg') }}" alt="Client 2" class="rounded-circle" style="width: 100px; height: 100px;">
    ...
    <!-- Client 3 -->
    <div class="col-md-3 text-center p-4 mb-4" style="border: 2px solidrgb(0, 0, 0); border-radius: 15px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
      <img src="{{ asset('images/thaiClient.jpg') }}" alt="Client 3" class="rounded-circle" style="width: 100px; height: 100px;">
